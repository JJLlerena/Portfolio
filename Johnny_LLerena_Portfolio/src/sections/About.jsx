...
function About() {
    return(
        <SectionContainer id="about" background="bg-black">
            <img src={Profileimg} alt="Profile Picture" className="w-32 h-32 rounded-full mx-auto my-4" />
            <h1 className="text-3xl font-bold text-white">About Me</h1>
            <p className="text-white my-2">Hey, I'm Johnny. CS grad from FIU currently working as a repair tech in the Keys while transitioning back into software development. I picked up my Security+ cert recently and I'm building out this portfolio to showcase what I can do with React and JavaScript.</p>
